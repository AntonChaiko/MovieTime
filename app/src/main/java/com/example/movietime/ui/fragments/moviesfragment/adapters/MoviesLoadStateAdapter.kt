...
import com.example.movietime.databinding.ItemErrorBinding
import com.example.movietime.databinding.ItemProgressBinding
...
class MoviesLoadStateAdapter : LoadStateAdapter<MoviesLoadStateAdapter.ItemViewHolder>() {
    ...
    class ErrorViewHolder internal constructor(
        ...
        override fun bind(loadState: LoadState) {
            ...
            binding.errorMessage.text = "Что-то пошло не так, проверьте подключение к интернету"
        }
